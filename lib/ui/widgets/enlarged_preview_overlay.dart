...
class _EnlargedPreviewOverlayState extends State<EnlargedPreviewOverlay> {
              ...
              Column(
                children: [
                  ...
                  _buildHeader(context, provider,
                      isLight: false, isDocument: isDocument),
                  // Main Content Area
                  Expanded(
    ...
    return Container(
      ...
      child: Column(
        children: [
          // Header
          _buildHeader(context, provider,
              isLight: true, isDocument: isDocument),
          // Main Content Area
          Expanded(
            child: Stack(
              children: [
  ...
  Widget _buildHeader(BuildContext context, DirectoryProvider provider,
      {required bool isLight, required bool isDocument}) {
    final color =
  ...
  Widget _buildScaleIndicator(BuildContext context, DirectoryProvider provider,
      Color color, bool isDocument) {
    if (isDocument) {
