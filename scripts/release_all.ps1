...
Write-Host "STEP 8: Committing changes and tagging..." -ForegroundColor Cyan
git add .
...
Write-Host ""
Write-Host "IMPORTANT: Push to GitHub to trigger Linux build (.deb)" -ForegroundColor Yellow
Write-Host "Command: git push origin main --tags" -ForegroundColor White
