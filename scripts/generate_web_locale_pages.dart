...
List<WebLocalePage> _pages(String version) => [
      ...
      WebLocalePage(
        ...
        description:
            'ReNameryは、Nameryの直感的な操作感を現代に復刻した一括リネームツールです。3ペインUIで変更後の名前を確認しながら、連番、正規表現置換、拡張子変更、Undo、画像/PDF/SVG/ZIPプレビューを利用できます。',
        ogDescription:
            'Nameryの操作感を現代に復刻。3ペインUIで変更後の名前を確認しながら、連番、正規表現置換、拡張子変更、Undo、各種プレビューを利用できます。',
        twitterDescription:
            '変更後の名前を確認しながら、連番、正規表現置換、拡張子変更、Undo、画像/PDF/SVG/ZIPプレビューを使える一括リネームツールです。',
        keywords:
            'ReNamery,リネームリー,Namery,ファイル名変更,一括リネーム,リネームソフト,連番,正規表現,拡張子変更,東洋クラフト',
        alternateNames: const ['リネームリー', 'Namery復刻リネーマー'],
        heading: 'ReNamery - 安全にプレビューできる一括ファイル名変更ツール',
        summary:
            'ReNameryは、名作リネームソフトNameryへのリスペクトから生まれた、現代向けの一括ファイル名変更ツールです。変更後の名前を実行前に確認しながら、連番、正規表現置換、拡張子変更、Undo、画像/PDF/SVG/ZIPプレビューを利用できます。',
        context:
